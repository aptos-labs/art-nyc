...
export type ArtData = ExtractStructType<ABITAble, typeof COLLECTION_ABI, "ArtData">;
export type PieceData = ExtractStructType<ABITAble, typeof COLLECTION_ABI, "PieceData">;
